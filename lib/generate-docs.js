...
function generateProp(propName, prop) {
  ...
  const defaultVal = generatePropDefaultValue(prop.defaultValue)

  return `> \`${propName}\` _${type}_ ${required}${description}${defaultVal}\n\n`
}
...
Object.keys(docFolders).forEach(folderName => {
  header += generateHeader(folderName)
